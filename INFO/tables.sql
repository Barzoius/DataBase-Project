...
CREATE SEQUENCE id_generatie_seq
START WITH 1
INCREMENT BY 1
MINVALUE 1
MAXVALUE 5
...
INSERT INTO GENERATIE (ID_GENERATIE, AN_INCEPUT, AN_SFARSIT, NR_CONSOLE)
VALUES (id_generatie_seq.NEXTVAL, 1997, 2000, 2);

INSERT INTO GENERATIE (ID_GENERATIE, AN_INCEPUT, AN_SFARSIT, NR_CONSOLE)
VALUES (id_generatie_seq.NEXTVAL, 2001, 2007, 6);

INSERT INTO GENERATIE (ID_GENERATIE, AN_INCEPUT, AN_SFARSIT, NR_CONSOLE)
VALUES (id_generatie_seq.NEXTVAL, 2005, 2012, 5);

INSERT INTO GENERATIE (ID_GENERATIE, AN_INCEPUT, AN_SFARSIT, NR_CONSOLE)
VALUES (id_generatie_seq.NEXTVAL, 2016, 2021, 9);

INSERT INTO GENERATIE (ID_GENERATIE, AN_INCEPUT, AN_SFARSIT, NR_CONSOLE)
VALUES (id_generatie_seq.NEXTVAL, 2017, 2022, 9);
